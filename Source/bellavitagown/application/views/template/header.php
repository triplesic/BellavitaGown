...
<link href="<?php echo base_url();?>css/font-awesome.min.css"
	rel="stylesheet">
<link href="<?php echo base_url();?>css/prettyPhoto.css"
	rel="stylesheet">
<link href="<?php echo base_url();?>css/price-range.css"
	rel="stylesheet">
...
<script type="text/javascript"
	src="<?php echo base_url();?>js/jquery.validate.min.js"></script>
<script type="text/javascript"
	src="<?php echo base_url();?>js/jquery-ui.min.js"></script>
<script type="text/javascript"
	src="<?php echo base_url();?>js/jquery.blockUI.js"></script>
...
<link rel="shortcut icon"
	href="<?php echo base_url();?>images/ico/favicon.ico">
...
<link rel="apple-touch-icon-precomposed"
	href="<?php echo base_url();?>images/ico/apple-touch-icon-57-precomposed.png">
</head>
<!--/head-->
						...
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i>
										bellavita_gown@hotmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="http://www.facebook.com/bellavita.bestqualitygown"
									target="_blank"><i class="fa fa-facebook"></i></a></li>
								<li><a href="http://line.me/ti/p/~bnandbv" target="_blank"> <i
										class="fa fa-line"
										style="display: inline-block; padding: 10px 15px;"> <img
											src="<?php echo base_url();?>images/line_logo_black.png"
											alt="" style="height: 1.2em;" />
									</i>
								</a></li>
					...
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo base_url();?>"><img
								src="<?php echo base_url();?>images/logo_new.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li id="showCart"><a href="<?php echo base_url()."order"?>"><i
										class="fa fa-shopping-cart"></i><?php echo lang('cart');?> (<?php echo $cartAmount; ?>)</a></li>


								<li><?php echo anchor('login', '<i class="fa fa-lock"></i>'.lang('login'));?></li>
						<?php }else { ?>
								<li><a href="<?php echo base_url();?>users/info"><i
										class="fa fa-user"></i><?php echo $userData['firstName']; ?> <?php echo $userData['lastName']; ?></a></li>
								<li id="showCart"><a href="<?php echo base_url()."order"?>"><i
										class="fa fa-shopping-cart"></i> <?php echo lang('cart');?> (<?php echo $cartAmount; ?>)</a></li>
					...
					<div class="col-sm-9">
						<div class="navbar-header">
							<button type="button" class="navbar-toggle"
								...
								<!-- 								<span class="icon-bar"></span> -->
								<!-- 								<span class="icon-bar"></span> -->
								<div style="color: white; font-weight: bold;">MENU</div>
							</button>
						</div>
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#"><?php echo lang('catalog')?><i
							...
							<?php if($userData['userType'] == "admin"){?>
                                <li><a
									href="<?php echo base_url()?>users/manage"><?php echo lang('user_management')?></a></li>
